    ...
    public class ProFinderContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Company>().HasData(
                ...
                new { Id = 5, Name = "Residential Cleaning", Description = "Best cleaning service in town, top-rated house cleaning service.", FoundedDate = new DateTime(2005, 02, 01), NumberOfEmployees = 4, CostPerHour = 35.00m, BusinessDays = "Daily", BusinessHours = "6:00 a.m. to 4:00 p.m.", CompanyTypeId = 3, ImageUrl = "http://i.imgur.com/8GKAgCU.jpg" },
                ...
                new { Id = 15, Name = "Animal care", Description = "Professional pet sitter for every type of pet.", FoundedDate = new DateTime(2016, 12, 01), NumberOfEmployees = 2, CostPerHour = 30.00m, BusinessDays = "Daily", BusinessHours = "9:00 a.m. to 6:00 p.m.", CompanyTypeId = 1, ImageUrl = "http://i.imgur.com/WAhHW1C.jpg" }
            );
